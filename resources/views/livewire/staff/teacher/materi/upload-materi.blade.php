        ...
        <div class="col-md-12">
            <form wire:submit.prevent="submit">
                <div class="mb-3">
                    ...
                    <input type="text" id="title" wire:model.blur="judul"
                        class="form-control @error('judul') is-invalid @enderror" placeholder="Masukkan judul materi">
                    @error('judul')
                ...
                <div class="mb-3">
                    ...
                    <textarea id="description" wire:model.blur="keterangan"
                ...
                <div class="mb-3">
                    <div class="form-group">
                        ...
                        <input type="file" id="file" wire:model.blur="file_materi"
                            class="form-control @error('file_materi') is-invalid @enderror" accept=".pdf">
                        @error('file_materi')
                        <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
