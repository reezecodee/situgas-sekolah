            ...
            <form wire:submit.prevent="submit">
                <div class="mb-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="title" wire:model.blur="judul_tugas" class="form-control @error('judul_tugas')
                            is-invalid
                        @enderror" placeholder="Masukkan judul tugas">
                        @error('judul_tugas')
                ...
                <div class="mb-3">
                    <div class="form-group">
                        ...
                        <input type="file" id="file" wire:model.blur="file_soal"
                            class="form-control @error('file_soal') is-invalid @enderror" accept=".pdf">
                        @error('file_soal')
                        <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
