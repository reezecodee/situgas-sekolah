                ...
                <div class="container-xl">
                    <ul class="navbar-nav">
                        ...
                        <x-student.link.nav-dropdown title="Akademik" page-target="akademik">
                            ...
                            <x-slot name="subitem">
                                <x-student.link.dropdown-item href="" page-target="akademik">Kalender
                                    akademik</x-student.link.dropdown-item>
                                <x-student.link.dropdown-item href="" page-target="akademik">Laporan
                                    belajar</x-student.link.dropdown-item>
                        ...
                        <x-student.link.nav-dropdown title="Pengajuan surat" page-target="pengajuan-surat">
                            ...
                            <x-slot name="subitem">
                                <x-student.link.dropdown-item href="" page-target="pengajuan-surat">Surat
                                    pengunduran diri</x-student.link.dropdown-item>
                                <x-student.link.dropdown-item href="" page-target="pengajuan-surat">Surat izin
                        ...
                        <x-student.link.navitem title="Bantuan" page-target="bantuan" href="student/dashboard">
                            <span class="nav-link-icon d-md-none d-lg-inline-block">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                                    fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round"
