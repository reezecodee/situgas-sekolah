                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="alamatPerusahaan" name="alamatPerusahaan" placeholder="Masukkan alamat perusahaan" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="alasan" name="alasan" rows="4" placeholder="Jelaskan alasan permohonan PKL" required></textarea>
                                </div>
                            </div>
                        </div>
